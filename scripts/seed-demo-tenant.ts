...
function main() {
  ...
  const organization: Organization = {
    ...
    branding: {
      ...
      supportEmail: 'wellness@acme.example',
    },
    plan: { tier: 'pilot', seats: headcount, contractStart: '2026-06-01', trial: true },
    policy: { identityMode: 'aggregate_only', kAnonymity: 5, escalationContact: 'safety@acme.example', retentionDays: 730, allowedCohortDims: ['department', 'location', 'tenureBand', 'level'] },
